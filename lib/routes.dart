...
final Map<String, WidgetBuilder> routes = {
  ...
  OrquideaScreen.routeName: (context) => OrquideaScreen(),
  ViveroScreen.routeName: (context) => ViveroScreen(),
  SolicitudviverosScreen.routeName: (context) => SolicitudviverosScreen(),
  SolicitudOrquideaScreen.routeName: (context) => SolicitudOrquideaScreen(),
  FormViveroScreen.routeName: (context) => FormViveroScreen(),
  FormOrquideaScreen.routeName: (context) => FormOrquideaScreen(),
};
